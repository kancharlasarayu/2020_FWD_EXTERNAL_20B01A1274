...
if(rad1.checked == false && rad2.checked == false && rad3.checked == false){ document.getElementById("radid").innerHTML = "Please select your gender" } 
else{ 
...
if(che1.checked == true || che2.checked == true || che3.checked == true){ document.getElementById("cheid").innerHTML = "" 
} 
else{ 
